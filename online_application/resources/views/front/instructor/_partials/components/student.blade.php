<div>
    ...
    <div style="float:right; margin-right: 5%">
        <a href="javascript:get_back_to_all_students({{$course->id}});">
    ...
    <div style="margin-left: 2%">
        <ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist"  style="margin-bottom: 2%">
            <li class="nav-item" id="li2"> 
                <a class="nav-link {{ $place ==  'student_attendance' ? 'active' : ''}}" id="pills-profile-tab" data-toggle="pill" href="#student_attendance" role="tab" aria-controls="pills-profile" aria-selected="false">{{__('Attendance')}}</a>
            </li>
            <li class="nav-item" id="li2"> 
                <a class="nav-link {{ $place ==  'student_grades' ? 'active' : ''}}" id="pills-profile-tab" data-toggle="pill" href="#student_grades" role="tab" aria-controls="pills-profile" aria-selected="false">{{__('Grades')}}</a>
            </li>
        </ul>
        <div class="tab-content tabcontent-border" >
            <div class="tab-pane {{ $place ==  'student_attendance' ? 'active' : ''}}" id="student_attendance" role="tabpanel">
                @include('front.instructor._partials.components.student.attendances')
            </div>
            <div class="tab-pane {{ $place ==  'student_grades' ? 'active' : ''}}" id="student_grades" role="tabpanel">
                @include('front.instructor._partials.components.student.grades')
            </div>
