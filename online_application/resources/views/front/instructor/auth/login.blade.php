                ...
                <div class="row">
                    <div class="col-12">
                        <form class="form-horizontal m-t-20" method="POST"
                              action="{{ route('school.instructor.login' , $school) }}">
                            @csrf
                            ...
                            <div class="form-group m-b-10 m-t-10">
                                ...
                                <div class="col-sm-12 text-right">
                                    ...
                                    {{__("Forgot password?")}} <a href="{{route('school.instructor.forgot.password' , $school)}}"
                                                                  class="m-l-5 text-link"><b>{{__("Reset Now")}}</b></a>
