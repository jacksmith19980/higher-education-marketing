@php
    ...
    $submittedApplication = $agentStudent->submissions()->with('application')->get();
    ...
    <div class="dropdown-menu" style="height: 200px; overflow-y: scroll">
        ...
        @foreach ($applications as $application)
            ...
            @if (in_array( $application->id , $submittedApplicationIds ))
                ...
                <a class="dropdown-item"
                   href="{{route('school.agent.student.submit' ,
                        ['school' => $school , 'application' => $application , 'student' => $agentStudent ])}}">
                    ...
                    <span>
                            ...
                            @php
                                ...
                                $submission =  $agentStudent->submissions()->where('application_id' , $application->id)->first();
            ...
            @else
                ...
                <a class="dropdown-item"
                   href="{{route('school.agent.student.submit' , ['school' => $school , 'application' => $application , 'student' => $agentStudent ])}}">
