                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-7 first-col">
                            <div class="content-container pt-4 pt-md-5 pb-0 px-4 px-md-5 h-100">
                                ...
                                @if(isset($settings['auth']['register_title_text']))
                                    {!! $settings['auth']['register_title_text'] !!}
                                @endif
                                @if(isset($settings['auth']['register_read_more_text']))
                                ...
                                @endif
                                @if(isset($settings['auth']['register_background']['path']))
                                  <img src="{{Storage::disk('s3')->temporaryUrl($settings['auth']['register_background']['path'], \Carbon\Carbon::now()->addMinutes(5))}}" alt="" srcset="" class="toogle-img">
                                @endif
                            </div>
