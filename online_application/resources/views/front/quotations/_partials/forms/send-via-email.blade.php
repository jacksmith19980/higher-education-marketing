<form action="{{route('send.quotations.email' , ['school' => $school , 'quotation' => $quotation])}}" method="POST" name="sendToEmailForm">
        @csrf
        <h3>Send this quote via email</h3>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    ...
                    [
                        ...
                        'required' => true,
                        'attr' => 'data-lang='.App::getLocale().' data-country-code=CAN',
                        'value' => '',
                        'data' => '',
                    ])
                </div>
