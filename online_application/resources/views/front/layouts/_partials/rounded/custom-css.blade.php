...
*/
    ...
    @import url(/media/css/icons/font-awesome/css/fontawesome-all.css);

    @import url(/media/css/icons/simple-line-icons/css/simple-line-icons.css);

    @import url(/media/css/icons/weather-icons/css/weather-icons.min.css);

    @import url(/media/css/icons/themify-icons/themify-icons.css);

    @import url(/media/css/icons/flag-icon-css/flag-icon.min.css);

    @import url(/media/css/icons/material-design-iconic-font/css/materialdesignicons.min.css);

    @import url(/media/css/icons/crypto-icons/cryptocoins.css);
 ...
 */
    ...
    :root {
        ...
        --yellow: {{isset($properties['secondary_color']) ? $properties['secondary_color'] : '#2962FF'}};
        ...
        --warning: {{isset($properties['secondary_color']) ? $properties['secondary_color'] : '#2962FF'}};
    ...
    *::after {
    ...
    .btn-warning {
        ...
        background-color: {{isset($properties['secondary_color']) ? $properties['secondary_color'] : '#2962FF'}};

        border-color: {{isset($properties['secondary_color']) ? $properties['secondary_color'] : '#2962FF'}};
    }
    ...
    .btn-outline-warning {
        ...
        color: {{isset($properties['secondary_color']) ? $properties['secondary_color'] : '#2962FF'}};
    ...
    .bg-warning {
        ...
        background-color: {{isset($properties['secondary_color']) ? $properties['secondary_color'] : '#2962FF'}}  !important;
    }
    ...
    .border-warning {
        ...
        border-color: {{isset($properties['secondary_color']) ? $properties['secondary_color'] : '#2962FF'}}  !important;
    }
    ...
    .text-info {
        ...
        color: {{isset($properties['secondary_color']) ? $properties['secondary_color'] : '#2962FF'}}  !important;
    }
...
*******************/
    ...
    .round.round-warning {
        ...
        background: {{isset($properties['secondary_color']) ? $properties['secondary_color'] : '#2962FF'}};
    }
...
*/
 ...
 ============================================================== */
    ...
    .school_oiart .auth-wrapper[style] {
        background: none !important;
    }

    .section-title strong {
        font-size: 20px;
        color: {{isset($properties['primary_color']) ? $properties['primary_color'] : '#2D5C7A'}};
        border-bottom: 2px solid{{isset($properties['primary_color']) ? $properties['primary_color'] : '#2D5C7A'}};
        display: block;
    }
...
<style type="text/css">
    ...
    .wizard-content .wizard > .steps > ul > li.current .step {
        @php
            $step_color = (isset($settings['applications']['step_color']) && $settings['applications']['step_color'] != '') ? $settings['applications']['step_color'] : ((isset($settings['branding']['main_color']) && $settings['branding']['main_color'] != '') ? $settings['branding']['main_color'] : '#1a8ec6');
        @endphp
    ...
    .text-main{
        @php
            $footer_link_color = (isset($settings['applications']['footer_link_color']) && $settings['applications']['footer_link_color'] != '') ? $settings['applications']['footer_link_color'] : ((isset($settings['branding']['main_color']) && $settings['branding']['main_color'] != '') ? $settings['branding']['main_color'] : '#1a8ec6');
        @endphp
        color:{{$footer_link_color}}
    }
    .wizard-content .wizard > .steps > ul > li.done .step {
        background-color: #fff;
        border-color: {{(isset($settings['branding']['secondary_color']) && $settings['branding']['secondary_color'] != '') ? $settings['branding']['secondary_color'] : '#1a8ec6'}};
        color: #424242;
    }
    ...
    {{--border-radius: 5px !important;--}}
     border-radius: 0px !important;
        background-color: {{(isset($settings['branding']['main_color']) && $settings['branding']['main_color'] != '') ? $settings['branding']['main_color'] : '#cc0033'}};
        width: 100%;
        color: #FFFFFF;
    }
...
.wizard-content .wizard > .actions > ul > li > a:active {
    ...
    {{--ul[role=tablist] li{--}}
{{--    background-color: {{isset($properties['tab_head_bg']) ? $properties['tab_head_bg'] : '##333333'}} !important;--}}
{{--}--}}
...
.step_icon {
        ...
        background-color: {{isset($properties['tab_head_bg']) ? $properties['tab_head_bg'] : '##333333'}};
        margin: 0 auto;
    }

    /*.school_asc-english .wizard > .steps a, .wizard > .steps a:hover, .wizard > .steps a:active ,*/
    /*.school_king-edward-college .wizard > .steps a, .wizard > .steps a:hover, .wizard > .steps a:active {*/
    /*padding: 0 !important;*/
    /*}*/
    /*.school_asc-english .wizard-content .wizard > .steps > ul > li,*/
    /*.school_king-edward-college .wizard-content .wizard > .steps > ul > li{*/
    /*overflow: hidden;*/
    /*}*/
    /*.school_asc-english .step_icon,*/
    /*.school_king-edward-college .step_icon{*/
    /*  width: 100%;*/
    /*  height:105px;*/
    /*}*/
    /*.form-check-inline{*/
    ...
    .file-upload-error .ajax-upload-dragdrop, .signature-error {
    ...
    .validation-wizard {
        /*border-radius:15px;*/
        /*box-shadow: 0 4px 8px 0 rgba(75,94,146,.24);*/
        /*border-top:1px solid #CCC;*/
    }

    .wizard-content .wizard > .actions {
        padding: 30px 20px;
        background-image: linear-gradient(to bottom, #dbdbdb, #ebebeb);
        border-top: 1px solid #CCC;
    }
    ...
    .actions a:hover {
        background-color: {{(isset($settings['branding']['main_color']) && $settings['branding']['main_color'] != '') ? $settings['branding']['main_color'] : '#cc0033'}}  !important;
        border-radius: 0 !important;
    }
...
div.payment_type {
    ...
    div.payment_type > input:checked + label {
        border: 1px solid #0069FF;
        background-color: #fff;
    }
    div.payment_type.custom-radio .custom-control-input:checked ~ .custom-control-label::before,
    div.payment_type.custom-radio .custom-control-input ~ .custom-control-label::before
     {
    ...
    div.payment_type.custom-radio .custom-control-input:checked ~ .custom-control-label::after{
    ...
    div.date_type > input:checked + label {
        border: 1px solid #0069FF;
        background-color: #fff;
    }
    div.date_type.custom-radio .custom-control-input:checked ~ .custom-control-label::before,
    div.date_type.custom-radio .custom-control-input ~ .custom-control-label::before
    {
    ...
    div.date_type.custom-radio .custom-control-input:checked ~ .custom-control-label::after{
    ...
    .nav_cumberland-college .navbar-brand img{
        max-height: 180px !important;
        position: absolute;
        top: 0;
        clip: rect(0px,230px,90px,0);
    }
    ...
    /* override for steps wizard on mobile Nov 3 2020*/
    @media screen and (max-width: 768px) {
        /* this will fix select overflowX */
        .select2-container {
            max-width: 100% !important;
        }
        /* override header h1 on mobile */
        .header-headline h1 {
        ...
        /* override steps UL changed to Flex */
        .wizard-content .wizard > .steps > ul {
            width: 100% !important;
            padding: 10px 15px 50px 20px !important;
            margin-bottom: 10px !important;
            display: flex !important;
            justify-content: center !important;
        }

        /* override steps number */
        .wizard-content .wizard.wizard-circle > .steps .step {
        ...
        /* override steps UL Li changed width from 100% to 20% changed to Flex */
        .wizard-content .wizard > .steps > ul > li {
            width: 20% !important;
        }

        /* override pseudo divider */
        ...
        /* override steps link changed layput to flex */
        ...
        /* override title hide for none active */
        .step_title {
            position: absolute;
            left: -20px;
            top: 100%;
        ...
        /* override title show for active */
        .current .step_title {
            display: block;
        }

        /* fix date column on mobile */
        div.date_type {
            width: 100% !important;
            padding: 15px;
            box-sizing: border-box;
