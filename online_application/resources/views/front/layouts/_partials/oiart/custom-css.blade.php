...
:root {
  ...
  --yellow: {{$properties['secondary_color']}};
  ...
  --warning: {{$properties['secondary_color']}};
...
.btn-warning {
  ...
  background-color: {{$properties['secondary_color']}};

  border-color: {{$properties['secondary_color']}}; }
...
.btn-outline-warning {
  ...
  color: {{$properties['secondary_color']}};
...
.bg-warning {
  ...
  background-color: {{$properties['secondary_color']}} !important; }
...
.border-warning {
  ...
  border-color: {{$properties['secondary_color']}} !important; }
...
/*   color: #2962FF !important; */
  color: {{$properties['secondary_color']}} !important;
}
...
.round {
  ...
  .round.round-warning {
    ...
    background: {{$properties['secondary_color']}}; }
...
.section-title strong{
  font-size: 20px;
  color: {{$application->properties['primary_color']}};
  border-bottom: 2px solid {{$application->properties['primary_color']}};
  display: block;
}
...
ul[role=tablist] li{
    background-color: {{$properties['tab_head_bg']}} !important;
}
...
.step_icon{
    ...
    background-color: {{$properties['tab_head_bg']}};
    margin: 0 auto;
}
