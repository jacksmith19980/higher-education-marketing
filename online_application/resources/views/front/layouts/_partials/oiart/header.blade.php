...
<meta name="description" content="{{isset($settings['branding']['description'])? $settings['branding']['description'] : ''}}">
...
@include('front.layouts._partials.oiart.custom-css' , ['properties' => $application->properties])
