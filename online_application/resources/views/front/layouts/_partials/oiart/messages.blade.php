            ...
            <li>
                <div class="message-center message-body">
                    @foreach ($newMessages as $newMessage)
                        @include('front.layouts._partials.oiart.message-notification' , ['message' => $newMessage])
                    @endforeach
                </div>
            </li>
            <li>
                <a class="nav-link text-center link" href="{{route('school.messages.index' , ['school' => $school])}}"> <b>{{__('See all messages')}}</b> <i class="fa fa-angle-right"></i> </a>
            </li>
        </ul>
    </div>
</li>
