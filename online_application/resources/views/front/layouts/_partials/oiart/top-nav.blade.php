...
{{--            </a>--}}
        ...
        <div class="navbar-collapse collapse pl-md-4" id="navbarSupportedContent">
            ...
            <a class="navbar-brand d-none d-md-block front-logo" style="width:200px;" href="{{ url('') }}">
                @if (!isset($settings))
                    @php
                        $settings = [];
                    @endphp
            ...
            <ul class="navbar-nav float-right">
                ...
                @include('front.layouts._partials.oiart.messages' , [
                    'newMessages' => DirectMessage::getNewMessages(Auth::guard('student')->user())
                ])
                <li class="nav-item dropdown">

                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ asset('media/images/users/menu-icon.svg') }}" alt="{{__('user')}}" class="" width="31"></a>
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd">
                        ...
                        <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                            ...
                            <div class="">
                                ...
                                @endif
                            <img src="{{--$student->avatar--}}" alt="user" class="img-circle" width="60" style="display: none;"></div>
