<form action="{{ route('quotation.booking' , ['school'=> $school , 'quotation' => $quotation]) }}" method="POST" class="m-b-30">
    ...
    <h4 class="m-b-20">{{__('Second Step : Create an account or ')}} <a href="javascript:void(0)" onclick="app.loadLoginForm(this)" data-quotation="{{$quotation->id}}" data-booking="{{$booking}}">{{'Login'}}</a> </h4>


    <p class="alert alert-info"> 
        <strong>To book,</strong> fill out the form below to create your account. or <a href="javascript:void(0)" onclick="app.loadLoginForm(this)" data-quotation="{{$quotation->id}}" data-booking="{{$booking}}"><strong>login</strong></a>, Then click <i>Book for a Child</i> to add your child’s details.
    </p>
