...
@endphp
<div style="padding:0" class="field_wrapper {{($properties['smart'])? 'smart-field ' : ''}} col-md-12 col-sm-12 col-xs-12 no-padding {{$properties['wrapper']['class']}}" {{ (!$properties['show'])? 'data-hidden=true' : ' ' }}
