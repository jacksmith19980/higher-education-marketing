	...
	<div class="row">
            ...
            <div class="col-md-6 offset-md-3">
                ...
                <div class="col-md-12">
                    ...
                    <button disabled style="margin-top:15px;" class="btn btn-success btn-block payment-btn btn-large" onclick="app.proccessPayment(this, 'authorize' , '{{ route('application.payment.pay.no-login' , ['school' => $school , 'application' => $application , 'invoice' => $invoice ]) }}' )">PAY</button>
