...
@if ( isset($invoice) &&  $invoiceStatus->status !='Paid')
    <div class="container mt-5 payment-form"  {{ isset($properties['disable_submission']) && ($properties['disable_submission'])  ? 'data-submit-button' : ''  }}  >
        <div class="row">
            ...
            <div class="col-md-6 offset-md-3">
                ...
                @csrf
                <input type="hidden" name="payment" class="cc_info" data-name="payment" value="bambora" />
                ...
                <div class="col-md-12">
                    <button disabled style="margin-top:15px;" class="btn btn-success btn-block payment-btn btn-large" onclick="app.proccessPayment(this, 'bambora' , '{{ route('application.payment.pay.no-login' , ['school' => $school , 'application' => $application , 'invoice' => $invoice ]) }}' )">PAY</button>
                </div>
            </div>
