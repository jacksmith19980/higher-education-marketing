...
>
		...
		<textarea   id="{{$name}}" 
			    	...
			    	@if(!$properties['label']['show']) placeholder = "{{$properties['placeholder']}}@if(isset($properties['validation']['required'])) *@endif"  @endif
					...
					>@if($value){{ $value }}@else{{ old($name) }}@endif</textarea>
