@if(!empty($cart['programs']))
    @include('front.applications.application-layouts.iframe.cartReview.partials.program-price-table', [
        'label' => 'Programs',
        'field' => $field,
...
@if(!empty($cart['courses']))
    @include('front.applications.application-layouts.iframe.cartReview.partials.course-price-table', [
        'label' => 'Courses',
        'field' => $field,
...
@if(!empty($cart['addons']))
    @include('front.applications.application-layouts.iframe.cartReview.partials.addons-price-table', [
        'label' => 'Addons',
        'field' => $field,
        'addons' => $cart['addons']
    ])
