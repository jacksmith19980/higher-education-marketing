...
>
		...
		<textarea   id="{{$name}}" 
			    	...
			    	@if(!$properties['label']['show']) placeholder = "{{__($properties['placeholder'])}}@if(isset($properties['validation']['required'])) *@endif"  @endif
					...
					>@if($defaultValue){{ $defaultValue }}@else{{ old($name) }}@endif</textarea>
