...
@if(array_key_exists('campus', $params['value']))
    ...
    <div id="{{$key}}" style="display: flex; flex-wrap: wrap;" class="col-md-12">
            ...
            @php
                ...
                $course_slug = $params['value']['courses'];
            @endphp
            ...
            <div class="col-md-12">
                <div class="start-date row form-group">
                    ...
                    @include('front.applications.application-layouts.rounded.course.partials.dates', [
                                'datesData' => $datesData,
                                'course' => $course,
                                'field' => $field,
                                'hash' => $key,
            ...
            @if(array_key_exists('course_addons', $params['value']) && array_key_exists($course_slug, $params['value']['course_addons']) )
                <div class="col-md-12">
                    <div class="course-addons-{{$key}} row form-group">
                        @include('front.applications.application-layouts.rounded.course.partials.addons', [
            ...
            @if(array_key_exists('date_addons', $params['value']) && array_key_exists('addons', $date->properties) && !empty($date->properties['addons']) )
                <div class="col-md-12">
                    ...
                    <div class="date-addons-{{$key}} row form-group">
                        @include('front.applications.application-layouts.rounded.course.partials.dates-addons', [
