    ...
    <form action="{{ route('assistants.register' , ['school'=> $school , 'assistantBuilder' => $assistantBuilder]) }}" method="POST" name="signupForm">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-6">
                ...
                'required' => true,
                'attr' => '',
                'value' => isset($student_information['first_name']) ? $student_information['first_name'] : '',
                'data' => '',
                ])
            </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-6">
                ...
                [
                    ...
                    'required' => true,
                    'attr' => '',
                    'value' => isset($student_information['last_name']) ? $student_information['last_name'] : '',
                    'data' => '',
                ])
            </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                [
                    ...
                    'required' => true,
                    'attr' => '',
                    'value' => isset($student_information['email']) ? $student_information['email'] : '',
                    'data' => '',
                ])
            </div>
        </div>
