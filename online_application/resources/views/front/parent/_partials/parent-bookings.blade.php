            ...
            <table class="table no-wrap v-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" data-application="{{$booking->quotation->application->id}}" class="btn btn-success" onclick="app.addStudent('{{route('school.parent.child.create' , $school)}}' , ' ' , 'Add Child' , this )"><i class="fa fa-plus"></i> {{__('Book for a child')}}</button>
                        </td>
                        ...
                        <td>
                            ...
                            {{-- <a href="{{ route('quotation.show' , ['school'=> $school , 'quotation' => $booking->quotation]) }}" class="btn btn-light" 
                            data-toggle="tooltip" data-placement="top" title="{{__('Get Another Price')}}"
                            onclick="app.getQuotationDetails({{ $booking->id }})">
