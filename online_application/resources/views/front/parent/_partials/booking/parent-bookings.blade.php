            ...
            <table class="table no-wrap v-middle">
                ...
                @foreach ($bookings as $booking)
                    ...
                    <tr data-booking-id="{{$booking->id}}">
                        ...
                        <td>
                            @price({{number_format($booking->invoice['totalPrice'])}}) {{__('per child')}}
                        ...
                        <td>
                            ...
                            <button type="button" data-application="{{$booking->quotation->application->id}}"
                                    ...
                                    onclick="app.addStudent('{{route('school.parent.child.create' , $school)}}' , ' ' , 'Book for a child' , this )">
                                <i class="fa fa-plus"></i> {{__('Book for a child')}}</button>
                        ...
                        <td>
                            ...
                            {{--  <a href="javascript:void(0)"  class="btn btn-sm btn-light btn-info text-danger" onclick="app.deleteBooking(this)" data-route="{{route('booking.destroy' , ['school' => $school , 'booking' => $booking ])}}" data-toggle="tooltip" data-placement="top" title="{{__('Delete Booking')}}" data-application="{{$booking->quotation->application->id}}" data-booking ="{{$booking->id}}"><span class="ti-trash"></span></a>  --}}
