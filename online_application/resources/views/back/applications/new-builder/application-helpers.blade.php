<div class="m-0 card">
    <div class="py-0 pt-2 pl-0 pr-1 ">
        ...
        data-target="#applicationHelpers" aria-expanded="false" aria-controls="app_pInfo">
        <h5>{{__("Application Helpers")}}</h5>
        <i class="mdi mdi-plus text-primary"></i>
        </div>
    </div>
    <div id="applicationHelpers" class="collapse" aria-labelledby="apph_pInfo" data-parent="#accordionExample" style="">
        <div class="p-0 card-body">
            @foreach (ApplicationHelpers::getFieldTypes() as $slug => $fieldType)
