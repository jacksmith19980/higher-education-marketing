...
<div class="tab-content tabcontent-border">
        <div class="tab-pane p-t-20 active" id="general" role="tabpanel">
                @include('back.applications.new-builder.fields.files-list.general')
        </div>

        <div class="tab-pane p-20" id="list" role="tabpanel">
                @include('back.applications.new-builder.fields.files-list.list')
        </div>

        <div class="tab-pane p-t-20" id="appearance" role="tabpanel">
                @include('back.applications.new-builder.fields.files-list.appearance')
        </div>
