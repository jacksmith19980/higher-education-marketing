...
<div class="tab-content tabcontent-border">
        ...
        <div class="tab-pane p-20 active" id="general" role="tabpanel">
            @include('back.applications.new-builder.fields.program.general')
        </div>

        <div class="tab-pane p-20" id="data" role="tabpanel">
            @include('back.applications.new-builder.fields.program.data')
        </div>
        <div class="tab-pane p-20" id="custom-fields" role="tabpanel">
            @include('back.applications.new-builder.fields.program.custom-fields')
        </div>
