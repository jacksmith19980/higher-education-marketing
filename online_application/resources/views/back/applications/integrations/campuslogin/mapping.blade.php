<div class="row">
    <div class="col-md-6">
        ...
        'helper_text' => 'Map Fields to Campuslogin',
        'default' => 1,
    ...
    <div class="col-md-6">
        <a href="javascript:void(0)" class="btn btn-success float-right spinner"
            onclick="app.loadMoreApplicationFields(this)" style="margin-top:16px">{{__("Add More Fields")}}</a>
    </div>
    @endif
</div>
