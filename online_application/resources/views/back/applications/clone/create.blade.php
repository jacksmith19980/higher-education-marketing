            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body wizard-content">
                        ...
                        <form method="POST" action="{{ route('application.cloning.store' , $application) }}"
                              class="validation-wizard wizard-circle m-t-40 needs-validation"
                              aria-label="{{ __('Update Application') }}" data-add-button="Update Application">
                            @csrf
                            ...
                            <section>
                                @include('back.applications._partials.application-general' , [
