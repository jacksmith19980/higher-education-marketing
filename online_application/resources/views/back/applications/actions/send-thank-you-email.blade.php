<div class="card" style="width: 100%">
    ...
    <div class="card-header bg-info text-white" role="tab" id="headingOne">
        ...
        <h5 data-toggle="collapse" data-parent="#accordion_application_action" href="#collapse3" aria-expanded="true" aria-controls="collapseOne" class="mb-0">Send Thank You Email</h5>
