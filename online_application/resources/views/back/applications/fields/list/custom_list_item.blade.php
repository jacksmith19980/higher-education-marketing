<div class="row repeated_fields" data-repeated="{{$order}}">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <input type="text" class="form-control ajax-form-field multi-element" name="custom_data[{{$order}}][label]" placeholder="Label" value="{{isset($label) ? $label : ''}}" onkeyup="app.manageCustomList();">
        </div>
    </div>

    <div class="col-md-5">
        <div class="form-group">
            <input type="text" class="form-control ajax-form-field multi-element" name="custom_data[{{$order}}][value]" placeholder="Value" value="{{isset($value) ? $value : ''}}" onkeyup="app.manageCustomList();">
        </div>
    </div>
