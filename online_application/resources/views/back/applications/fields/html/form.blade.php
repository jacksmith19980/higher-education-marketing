<form  method="POST" action="{{ route($route , $field ) }}" class="validation-wizard wizard-circle" id="ajax-form">
...
<div class="tab-content tabcontent-border">
    ...
    <div class="tab-pane p-20 active" id="general" role="tabpanel">
           @include('back.applications.fields.html.general')
    </div>

    <div class="tab-pane p-20" id="appearance" role="tabpanel">
            @include('back.applications.fields.html.appearance')
    </div>
