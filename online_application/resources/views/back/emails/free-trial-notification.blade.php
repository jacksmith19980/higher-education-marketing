...
<![endif]-->
                        <div
                            style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;line-height:1.2;padding-top:25px;padding-right:40px;padding-bottom:10px;padding-left:40px;">
                            <div
                                ...
                                <p
                                    ...
                                    <span style="font-size: 30px; color: #2b303a;"><strong>{{__("New
                                            Free Trial Account!")}}</strong></span>
                                </p>
                            </div>
                        </div>
                        <!--[if mso]>
...
<![endif]-->
                        <div
                            ...
                            <div
                                ...
                                <p
                                    style="font-size: 15px; line-height: 1.5; text-align: left; word-break: break-word; font-family: inherit; mso-line-height-alt: 23px; margin: 0;">
                                    <span style="color: #808389; font-size: 15px;">

                                        <h4>{{__('User\'s Details')}}</h4>

                                        <p><strong>{{__('Name')}}:</strong> {{$user->name}}</p>
                                        <p><strong>{{__('Email')}}:</strong> {{$user->email}}</p>
                                        <p><strong>{{__('Phone')}}:</strong> {{$user->phone}}</p>
                                        <p><strong>{{__('Position')}}:</strong> {{$user->position}}</p>

                                        <hr />

                                        <h4>{{__('School\'s Details')}}</h4>
...
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:46.5pt; width:212.25pt; v-text-anchor:middle;" arcsize="97%" stroke="false" fillcolor="#1aa19c">
<w:anchorlock/>
