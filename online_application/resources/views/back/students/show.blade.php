                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-0 p-0 col">
                                            <div class="avatar-upload">
                                                ...
                                                <div class="avatar-preview" id="{{ $applicant->avatar }}">
                                                    @if($applicant->avatar)
                                                        @php
                                                            $storageUrl =$applicant->profileImage;
                                                        @endphp
                                        ...
                                        <div class="col flex-grow-1">
                                            <div class="applicant-main-info">
                                                ...
                                                @if(!is_array($applicant->phone) && $applicant->phone != '')<p
                                                        class="mb-1">{{ $applicant->phone }}
                                                </p>
                        ...
                        <div class="student-record-content">
                            <nav class="mb-3">
                                <div class="nav nav-tabs inline-tabs" id="nav-tab" role="tablist">
                                    <a class="nav-link active text-uppercase" id="nav-profile-tab" data-toggle="tab"
                                        href="#nav-profile"
                                ...
                                <a class="nav-link text-uppercase" id="nav-contact-tab" data-toggle="tab"
                                    href="#nav-academic" role="tab"
                                    aria-controls="nav-academic" aria-selected="false">{{__('Academic')}}</a>

                                <a class="nav-link text-uppercase" id="nav-contact-tab" data-toggle="tab"
                                    href="#nav-attendance" role="tab"
                                ...
                                <a class="nav-link text-uppercase" id="nav-gades-tab" data-toggle="tab"
                                    href="#nav-grades" role="tab"
                                    aria-controls="nav-grades text-uppercase"
