...
@section('scripts')
    ...
    <script>
        url_classrooms = '{{route('classroomSlots.classrooms', ['classroom' => $classroom])}}';
        url_classroomSlots = '{{route('classroomSlots.classroomSlots', ['classroom' => $classroom])}}';
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                customButtons: {
                    addEventButton: {
                        text: 'Add Lesson',
                        click: function() {
                            app.lessonCreate("{{route('lessons.createWithClassroom', ['classroom' => $classroom])}}","","data-group-id");
                        }
                    }
                },
