    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-light">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ url('/dashboard') }}">
                ...
                <div class="logo">
                          <img src="media/images/hem_logo.png" style="width:80px;">
                      </div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href=""
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                            src="../../assets/images/users/menu-icon.svg" alt="{{__('user')}}" width="31"></a>
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd">
                        ...
                        <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                            ...
                            <div class=""><img src="../../assets/images/users/1.jpg" alt="{{__('user')}}" class="img-circle"
                                    width="60"></div>
                        ...
                        <a class="dropdown-item" href="{{route('user.profile')}}"><i class="ti-user m-r-5 m-l-5"></i> My
                            Profile</a>
