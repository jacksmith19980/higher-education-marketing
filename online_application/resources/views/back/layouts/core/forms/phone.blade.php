<div class="form-group">
    ...
    <label style="display:block" for="{{$name}}">{{ __($label) }}{!! ($required)? '<span class="text-danger">*</span>' : '' !!}</label>
    ...
    <div class="input-group-prepend">
        ...
        <input id="{{$name}}" type="text"
            class="form-control{{ $errors->has($name) ? ' is-invalid' : '' }} {{$class}} form-control-lg inter-calling-code-mode"
            data-disabled="false"
            data-lang="en"
