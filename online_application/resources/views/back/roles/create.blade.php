            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body wizard-content">
                        ...
                        <form method="POST" action="{{ route('roles.store') }}" class="validation-wizard wizard-circle m-t-40"
                                aria-label="{{ __('Create Role') }}" data-add-button="{{__('Add Role')}}"  enctype="multipart/form-data">
                        @csrf
                        <!-- Step 1 -->
                            ...
                            <section>
                                <div id="permissions_selection" class="row">
                                    <div class="col-lg-4 col-xl-3">
                                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                            ...
                                            <a class="nav-link" id="v-pills-applications-tab" data-toggle="pill" href="#v-pills-applications" role="tab" aria-controls="v-pills-applications" aria-selected="false">{{__('Application Forms')}}</a>

                                            <a class="nav-link" id="v-pills-submissions-tab" data-toggle="pill" href="#v-pills-submissions" role="tab" aria-controls="v-pills-submissions" aria-selected="false">{{__('Submissions')}}</a>
                                    ...
                                    <div class="col-lg-8 col-xl-9">
                                        <div class="tab-content" id="v-pills-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="v-pills-submissions" role="tabpanel" aria-labelledby="v-pills-submissions-tab">@include('back.permissions.submissions')</div>
                                ...
                                <div id="full_permission" class="hidden">
                                    <div class="row">
                                        <div class="col-md-12">
