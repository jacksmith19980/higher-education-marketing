            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body wizard-content">
                        <h4 class="card-title">{{__('Add Instructors')}}</h4>
                        <hr>

                        <form method="POST" action="{{ route('instructors.store') }}"
                              class="validation-wizard wizard-circle m-t-40" aria-label="{{ __('Create Instructors') }}"
                              data-add-button="{{__('Save')}}">
                            @csrf

                            <h6>{{__('Instructor\'s Information')}}</h6>
                            <section>
