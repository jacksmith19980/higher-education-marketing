 ...
 * @version    $Id: Numeric.php 1856 2023-05-02 06:47:28Z jan.slabon $
 */
    ...
    implements SetaPDF_Core_Type_ScalarValue
{
    ...
    {
        if ($value === null || SetaPDF_Core::isZero($value)) { // null is kept for BC
            $writer->write(' 0');
        } elseif (is_int($value)) {
            $writer->write(' ' . $value);
        } else {
    ...
    {
        if (SetaPDF_Core::isZero($this->_value)) {
            return ' 0';
        }
