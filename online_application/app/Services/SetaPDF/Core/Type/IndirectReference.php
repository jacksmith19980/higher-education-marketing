 ...
 * @version    $Id: IndirectReference.php 1839 2023-03-23 10:47:22Z jan.slabon $
 */
    ...
    implements SetaPDF_Core_Type_IndirectObjectInterface
{
    ...
    {
        return self::_ensureType(self::class, $value, 'Indirect reference value expected.', false);
    }
     ...
     * The constructor.
     *
     * @param integer|SetaPDF_Core_Type_IndirectObjectInterface $objectId
