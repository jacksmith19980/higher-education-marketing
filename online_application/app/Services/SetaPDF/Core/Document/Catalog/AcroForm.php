 ...
 * @version    $Id: AcroForm.php 1868 2023-08-25 06:35:57Z jan.slabon $
 */
...
class SetaPDF_Core_Document_Catalog_AcroForm
{
    ...
    public function getDictionary($create = false)
    {
        ...
        if ($root) {
            ...
            if ($create === true && !$this->_dictionary instanceof SetaPDF_Core_Type_Dictionary) {
        ...
        return $this->_dictionary instanceof SetaPDF_Core_Type_Dictionary
            ? $this->_dictionary
            : false;
    }
