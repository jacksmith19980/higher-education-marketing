 ...
 * @version    $Id: Extensions.php 1868 2023-08-25 06:35:57Z jan.slabon $
 */
...
class SetaPDF_Core_Document_Catalog_Extensions
{
    ...
    public function getDictionary($create = false)
    {
        ...
        if (!$root instanceof SetaPDF_Core_Type_Dictionary) {
            return null;
        }
    ...
    {
        $dictionary = $this->getDictionary();
        if (!$dictionary instanceof SetaPDF_Core_Type_Dictionary || !$dictionary->offsetExists($name)) {
            return false;
        }
