 ...
 * @version    $Id: AppearanceCharacteristics.php 1870 2023-08-25 10:14:31Z jan.slabon $
 */
...
class SetaPDF_Core_Document_Page_Annotation_AppearanceCharacteristics
{
    ...
    public function getBorderColor()
    {
        ...
        if (!$bc instanceof SetaPDF_Core_Type_Array) {
            return null;
        }
    ...
    public function getBackgroundColor()
    {
        ...
        if (!$bg instanceof SetaPDF_Core_Type_Array) {
            return null;
        }
