 ...
 * @version    $Id: CrossReferenceTable.php 1836 2023-03-07 10:03:04Z jan.slabon $
 */
        ...
        while ($xrefOffset !== false) {
            ...
            if ($initValue instanceof SetaPDF_Core_Type_Token && $initValue->getValue() === 'xref') {
                ...
                if (
                    ...
                    // let's record the position of this object
                    $this->_parserObjectOffsets[$initValue->getObjectId()][$initValue->getGen()] = [
                        $xrefOffset,
                        $initValue->getGen()
                    ];
