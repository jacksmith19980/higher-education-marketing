...
class SetaPDF_Core_Text
{
     ...
     * @var string
     */
    const ALIGN_JUSTIFY_ALL = 'justify-all';
     ...
     * @var array
     */
    public static $possibleDelimiter = [
        // 0 = right breaking
     ...
     * @var array
     */
    public static $possibleGlueCharacters = [
        ...
        for ($i = 0; $i < $len; $i++) {
            ...
            if (
                ...
                if ($lastDelimiterPos === null) {
                    ...
                    if (!SetaPDF_Core::isZero($charSpacing)) {
            ...
            if (!SetaPDF_Core::isZero($wordSpacing) && $char === "\x00\x20") {
                $lineWidth += $wordSpacing;
            }

            if (SetaPDF_Core::isNotZero($charSpacing)) {
