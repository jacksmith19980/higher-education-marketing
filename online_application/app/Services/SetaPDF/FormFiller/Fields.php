 ...
 * @version    $Id: Fields.php 1805 2023-01-23 14:00:59Z jan.slabon $
 */
...
class SetaPDF_FormFiller_Fields implements Countable, Iterator, ArrayAccess
{
    ...
    public function beforeFieldFlattenOrDelete(SetaPDF_FormFiller_Field_FieldInterface $field)
    {
        ...
        if ($xfa && !$this->_handleAllFieldsActive) {
     ...
     * @return void
     */
    public function flatten($field = null, $recreateAppearanceIfNeedAppearancesIsSet = false)
    {
        if (null === $field) {
            $this->_handleAllFieldsActive = true;
            ...
            foreach ($this->getNames() AS $name) {
                $this->get($name)->flatten($recreateAppearanceIfNeedAppearancesIsSet);
            }
        ...
        $field->flatten($recreateAppearanceIfNeedAppearancesIsSet);
    }
    ...
    protected function _readFormFields()
    {
        ...
        if ($acroForm) {
            ...
            $availableFieldTypes = [
                'ButtonGroup' => is_readable(__DIR__ . '/Field/ButtonGroup.php'),
                'Text'        => is_readable(__DIR__ . '/Field/Text.php'),
                'List'        => is_readable(__DIR__ . '/Field/List.php'),
                'Button'      => is_readable(__DIR__ . '/Field/Button.php'),
                'PushButton'  => is_readable(__DIR__ . '/Field/PushButton.php'),
                'Signature'   => is_readable(__DIR__ . '/Field/Signature.php')
            ];
            unset($dir);
                ...
                // All other fields
                    ...
                    if ($name !== $originalName) {
                        if (!isset($this->_relatedFields[$originalName])) {
                            $this->_relatedFields[$originalName] = [$originalName];
                        }
