 ...
 * @version    $Id: Text.php 1855 2023-04-28 10:34:15Z jan.slabon $
 */
    ...
    public function recreateAppearance()
    {
        ...
        if ($value) {
            ...
            $left = $this->_textTranslateData['x']
                + (SetaPDF_Core::isZero($borderWidth)
                    ? 2
            ...
            if ($this->isCombField() && $maxLength) {
                ...
                if ($q && SetaPDF_Core::isNotZero($maxLength - $len)) {
                ...
                if ($borderColor && (
                        ...
                        $borderStyle === SetaPDF_Core_Document_Page_Annotation_BorderStyle::DASHED
                    )) {
                ...
                if ($this->isMultiline()) {
                    ...
                    foreach ($lines AS $line) {
                        ...
                        $charCodeString = implode('', $charCodes);
