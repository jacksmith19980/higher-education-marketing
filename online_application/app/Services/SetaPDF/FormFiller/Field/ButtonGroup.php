 ...
 * @version    $Id: ButtonGroup.php 1805 2023-01-23 14:00:59Z jan.slabon $
 */
...
class SetaPDF_FormFiller_Field_ButtonGroup implements SetaPDF_FormFiller_Field_FieldInterface
{
    ...
    /**
     * Recreate or creates the Appearance of the form fields.
     *
     * @return void
     * @internal
     */
    ...
    public function flatten($recreateAppearanceIfNeedAppearancesIsSet = false)
    {
        ...
        while (($button = current($this->_buttons)) !== false) {
            $button->flatten($recreateAppearanceIfNeedAppearancesIsSet);
        }
    }
