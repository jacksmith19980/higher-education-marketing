...
class AddSubmittionUpdatedNotification
{
    /**
     * Handle the event.
     *
    ...
    public function handle(ApplicationSubmissionEvent $event)
    {
        ...
        $notification->text = '<a href="javascript:void(0)" class="message-item">
                                        ...
                                        <span class="mail-contnet">
                                            <h5 class="message-title">'.$event->student->name.'</h5> <span class="mail-desc">Updated the application data!</span> <span class="time">'.$event->submission->updated_at.'</span> </span>
                                    </a>';
