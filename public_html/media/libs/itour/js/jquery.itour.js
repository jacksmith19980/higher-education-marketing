						...
						if (hData.opt.introShow){
							if(hWrap.data().itour_go){
								...
								hData.v.introDialog = $('<div>')
									...
									//.html('<div class="row"><div class="col-md-6 col-sm-12 col-xs-12 introCol"><div class="hContImage"></div><div class="hContHeader">'+hData.opt.lang.introTitle+'</div><div class="hContBody">'+hData.opt.lang.introContent+'</div><div class="hContFooter" style="text-align:right"><span class="hBtn hAbortBtn hClose">'+hData.opt.lang.introDialogBtnCancel+'</span><span class="hBtn hStartBtn">'+hData.opt.lang.introDialogBtnStart+'</span></div></div></div>')
									.appendTo('body');
