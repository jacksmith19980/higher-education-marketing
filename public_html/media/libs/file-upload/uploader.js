    ...
    a.fileapi = void 0 !== e("<input type='file'/>").get(0).files, a.formdata = void 0 !== window.FormData, e.fn.uploadFile = function (t) {
        ...
        function l(a, t, r)
        {
            ...
            if (-1 != a.maxFileSize && r[o].size > a.maxFileSize) {
                ...
                var C = e("<form style='display:block; position:absolute;left: 150px;' class='" + t.formGroup + "' method='" + a.method + "' action='" + a.url + "' enctype='" + a.enctype + "' novalidate></form>");
        ...
        function h(t, r, o, s)
        {
            ...
            var i = "ajax-upload-id-" + (new Date).getTime(),
                ...
                d = e("<form method='" + o.method + "' action='" + o.url + "' enctype='" + o.enctype + "' novalidate></form>"),
        ...
        var w = e.extend({
            ...
            dragDropStr: "",
            uploadStr: "<span class='uploadTitle'><b>Drag &amp; Drop Files</b></span>",
            abortStr: "Abort",
            cancelStr: "Cancel",
            deleteStr: "Delete",
            doneStr: "<i class='fas fa-check'></i> Done",
