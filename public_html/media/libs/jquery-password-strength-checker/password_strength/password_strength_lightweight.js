...
;(function ( $, window, document, undefined ) {
    ...
    var allLetters = new RegExp('[A-Za-z]');
    ...
    Plugin.prototype._create = function () {
		...
		$("#password").addClass(options.inputClass);
        ...
        this.element.append(
            ...
            <ul> \
            <li data-criterion="letter" class="invalid">At least <strong>one letter</strong></li> \
			...
			<li data-criterion="specialchar" class="invalid">At least <strong>one special character</strong></li> \
			<li data-criterion="length" class="invalid">Be at least <strong>8 characters</strong></li> \
			</ul> \
            </div>');
    ...
    Plugin.prototype._bind_input_events = function($s) {
        ...
        $s.bind('keyup', function () {
			...
			var letters = password.match(allLetters) ? 1 : 0;
			var specialchars = password.match(specialCharacters) ? 1 : 0;
			...
			that._update_info('letter', letters);
			that._update_info('specialchar', specialchars);
        }).focus(function () {
