...
$(document).ready(function () {
    ...
    {
        if ( $('#main-wrapper').hasClass('mini-sidebar') ) {
            $('[data-toggle=tooltip]').tooltip('disable');  // (Re-)enable tooltips

        } else {
            $('[data-toggle=tooltip]').tooltip('enable'); // Disable tooltips
        }
    }
    // validateToolTip();
    $('.sidebar-nav-toggler.sidebartoggler').click(function () {
        validateToolTip();
    });
});